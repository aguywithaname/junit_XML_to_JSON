...
public class Testsuite implements Serializable {
	...
	private static final long serialVersionUID = -6564781337602354070L;
    ...
    // Junit XML results do no put test cases in a <list> </list> wrapper so we need to disable the wrapping
